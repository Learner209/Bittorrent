...
class TorrentClient:
    ...
    def __init__(self, torrent, UIWindow):
        ...
        self.piece_manager = PieceManager(torrent, UIWindow)
        self.abort = False
...
class Piece:
    ...
    def __init__(self, index: int, blocks: [], hash_value, UIWindow):
        self.index = index
        self.blocks = blocks
        ...
        for index, hash_value in enumerate(torrent.pieces):
            ...
            if index < (total_pieces - 1):
                ...
                if last_length % REQUEST_SIZE > 0:
                    ...
                    blocks[-1] = last_block
            pieces.append(Piece(index, blocks, hash_value, self.UIWindow))
        return pieces
        ...
        if piece:
            ...
            if piece.is_complete():
                if piece.is_hash_matching():
                    ...
                    #self.UIWindow.progressBar.setValue(100 * complete / self.total_pieces)
                else:
