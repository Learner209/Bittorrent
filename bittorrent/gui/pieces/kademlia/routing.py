...
from pieces.kademlia.utils import shared_prefix, bytes_to_bit_string
...
class KBucket:
    ...
    def split(self): ## Split the previous Kbucket instance into halves and make it into two buckets
    ...
    def depth(self): ## Find the longest number of shared prefix of all of this K bucket's nodes'values
...
class TableTraverser:
    def __init__(self, table, startNode):
        index = table.get_bucket_for(startNode) ##Find the index of the startNode in the routing table's bucket
...
class RoutingTable:
    ## Peer contact info is basically including ip, port, the node id of the peer
    ...
    def flush(self): ## The info hash has 0~2**160 possiblieties, 
